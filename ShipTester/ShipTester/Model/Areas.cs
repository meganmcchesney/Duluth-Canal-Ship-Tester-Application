namespace ShipTester.Model
{
    ...
    public static class Areas
    {
        ...
        /// </summary>
        public static readonly Polygon DuluthSuperiorHarbor = new Polygon(
            "InsideHarbor", new[] {
        ...
        /// </summary>
        public static readonly Polygon StLouisBay = new Polygon(
            "StLouisBay", new[] {
        ...
        /// </summary>
        public static readonly Polygon[] All = typeof(Areas).GetFieldValues<Polygon>();
    }
}
